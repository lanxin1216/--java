...
public class Tank {
    ...
    static {
        tankImags = new Image[] {
//                tk.getImage(BombTank.class.getClassLoader().getResource("Images/tankD.gif")),


                tk.getImage(BombTank.class.getClassLoader().getResource("Images/tankD.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/tankU.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/tankL.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/tankR.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankD.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankU.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankL.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankR.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankD2.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankU2.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankL2.gif")),
                tk.getImage(BombTank.class.getClassLoader().getResource("Images/HtankR2.gif")),
        };
    ...
    public Tank(int x, int y, boolean good, Direction dir, GameWindow02 tc, int player) {
        this(x, y, good);
        this.direction = dir;
        this.tc = tc;
        this.player=player;
...
//        new DrawBloodbBar().draw(g);
    ...
    void move() {
        ...
        if (y < 40)
            y = 40;
        if (x + Tank.width > GameWindow02.Fram_width)
            x = GameWindow02.Fram_width - Tank.width;
        if (y + Tank.length > GameWindow02.Fram_length)
            y = GameWindow02.Fram_length - Tank.length;
        ...
        if (player==1){
            switch (key) {
                case KeyEvent.VK_R:
                    ...
                    GameWindow02 abc=new GameWindow02();
